                    ...
                    <CardContent className="space-y-6 pt-4 text-center">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left p-4 bg-slate-50 dark:bg-gray-900 rounded-xl">
                            <div className="flex gap-3">
                                ...
                                <span className="text-sm text-gray-700 dark:text-gray-300">Evaluate corpus adequacy</span>
                            </div>
                            <div className="flex gap-3">
                                <CheckCircle2 className="w-5 h-5 text-green-600 shrink-0" />
                                <span className="text-sm text-gray-700 dark:text-gray-300">Check insurance coverage</span>
                            </div>
                            <div className="flex gap-3">
                                <CheckCircle2 className="w-5 h-5 text-green-600 shrink-0" />
                                <span className="text-sm text-gray-700 dark:text-gray-300">Review asset allocation</span>
                            </div>
                            <div className="flex gap-3">
                                <CheckCircle2 className="w-5 h-5 text-green-600 shrink-0" />
                                <span className="text-sm text-gray-700 dark:text-gray-300">Get actionable steps</span>
                            </div>
                        </div>
                    </CardContent>
                ...
                <Card className="border-t-4 border-t-indigo-600 shadow-lg animate-in fade-in zoom-in duration-300">
                    ...
                    <CardContent className="p-8">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6 flex items-center gap-2">
                            <TrendingUp className="w-6 h-6 text-indigo-600 dark:text-indigo-400" /> Action Plan
                        </h3>
            ...
            <Card className="max-w-2xl mx-auto border-t-4 border-t-indigo-600 shadow-lg min-h-[500px] flex flex-col">
                ...
                <CardContent className="flex-1 space-y-6 pt-2">
                    ...
                    {currentResponse && currentQuestion.optionsHint[currentResponse.optionIndex] && (
                        <div className="mt-4 p-4 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-900 text-indigo-900 dark:text-indigo-100 text-sm animate-in fade-in slide-in-from-top-1">
                ...
                <CardFooter className="flex justify-between border-t border-gray-100 dark:border-gray-800 p-6 bg-slate-50 dark:bg-gray-900 rounded-b-xl">
