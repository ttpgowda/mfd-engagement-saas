...
export function RiskGauge({ score, category, animated = true }: RiskGaugeProps) {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center py-8">
            ...
            {/* Labels */}
            <div className="absolute bottom-8 left-0 text-xs font-bold text-emerald-600 px-2">Conservative</div>
            <div className="absolute bottom-8 right-0 text-xs font-bold text-rose-600 px-2">Aggressive</div>
        </div>
    );
}
