...
export default function AboutPage() {
    return (
        <div className="bg-white dark:bg-black transition-colors">
                ...
                <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
                        ...
                        <h1 className="mt-10 text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-6xl">
                            Democratizing <span className="text-indigo-600 dark:text-indigo-400">Financial Freedom</span>
                        </h1>
                        ...
                        <div className="mt-10 flex items-center gap-x-6">
                            ...
                            <a href="/contact" className="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-100 group">
                    ...
                    <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mt-0 lg:mr-0 lg:max-w-none lg:flex-none xl:ml-32">
                        <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                            <div className="-m-2 rounded-xl bg-gray-900/5 dark:bg-gray-100/5 p-2 ring-1 ring-inset ring-gray-900/10 dark:ring-gray-100/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                                <div className="rounded-md bg-white dark:bg-gray-900 p-8 shadow-2xl ring-1 ring-gray-900/10 dark:ring-gray-100/10 sm:rounded-xl">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="p-4 bg-green-50 dark:bg-green-950/40 rounded-lg">
                                            ...
                                            <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">SEBI</div>
                                            <div className="text-sm text-gray-600 dark:text-gray-300">Aligned Tools</div>
                                        </div>
                                        <div className="p-4 bg-purple-50 dark:bg-purple-950/40 rounded-lg col-span-2">
                                            ...
                                            <div className="text-sm text-gray-600 dark:text-gray-300">Unbiased Analysis</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            {/* Values Section */}
            <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24 bg-slate-50 dark:bg-gray-900/50">
                <div className="mx-auto max-w-2xl lg:text-center">
                    <h2 className="text-base font-semibold leading-7 text-indigo-600 dark:text-indigo-400">Why We Exist</h2>
