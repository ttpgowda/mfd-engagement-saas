...
export function FinancialHealthCheckWizard({ isPublicView = false, sharedCode, onComplete }: FinancialHealthCheckWizardProps) {
    ...
    if (currentStep === 0) {
        return (
            <ToolPageLayout
                ...
                description="Discover your financial fitness in just 5 minutes."
    ...
    if (currentStep === 99) {
        ...
        return (
            <ToolPageLayout
                ...
                description={`Score: ${green * 10 - red * 10}`}
                isPublicView={isPublicView}
            >
    ...
    return (
        <ToolPageLayout
            ...
            config={{}}
            title="Financial Health Check"
            description="Assess client financial health."
            isPublicView={isPublicView}
        >
            <Card className="max-w-2xl mx-auto border-t-4 border-t-primary shadow-lg min-h-[500px] flex flex-col">
                <CardHeader>
                    <div className="flex justify-between items-start">
                        ...
                        <div className="ml-4">
                            {isPublicView && <div className="hidden md:block"><PublicShareButton /></div>}
                        </div>
                    </div>
                </CardHeader>
