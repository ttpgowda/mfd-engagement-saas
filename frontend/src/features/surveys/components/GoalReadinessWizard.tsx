    ...
    if (currentStep === 0) {
        return (
            <ToolPageLayout
                ...
                config={{}}
                title={GOAL_READINESS_DATA.meta.name}
                description={GOAL_READINESS_DATA.meta.description}
                            ...
                            return (
                                <div key={idx}
                                    ...
                                    <div className="flex-1 pl-2">
                                        ...
                                        {hint && (
                                            <p className={cn("text-xs mt-1 font-normal", isSelected ? "text-emerald-700 dark:text-emerald-300" : "text-muted-foreground")}>
                                                {hint}
                                            </p>
                                        )}
                                    </div>
